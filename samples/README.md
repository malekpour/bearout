...
| [`decision-records`](decision-records/) | synthetic | A decision log with citable rulings | Fragments, shared helpers via `load()`, project checks, a generator with provenance |
